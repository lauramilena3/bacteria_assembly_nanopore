...
rule multiQC:
	...
	message:
		"Generating MultiQC report for {sample}"
	conda:
		dirs_dict["ENVS_DIR"]+ "/QC.yaml"
	benchmark:
...
rule postQualityCheckIlluminaPE:
	input:
		...
		unpaired=dirs_dict["CLEAN_DATA_DIR"] + "/{sample}_unpaired_clean.fastq",
	output:
		html_forward=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_forward_paired_clean.fastqc.html"),
		zipped_forward=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_forward_paired_clean.fastqc.zip"),
		html_reverse=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_reverse_paired_clean.fastqc.html"),
		zipped_reverse=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_reverse_paired_clean.fastqc.zip"),
		html_unpaired=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_unpaired_clean.fastqc.html"),
		zipped_unpaired=temp(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_unpaired_clean.fastqc.zip"),
	params:
...
rule postMultiQC:
	input:
		...
		zipped_forward=expand(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_forward_paired_clean.fastqc.zip", sample=SAMPLES),
		html_reverse=expand(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_reverse_paired_clean.fastqc.html", sample=SAMPLES),
		zipped_reverse=expand(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_reverse_paired_clean.fastqc.zip", sample=SAMPLES),
		html_unpaired=expand(dirs_dict["CLEAN_DATA_DIR"] + "/postQC" + "/{sample}_unpaired_clean.fastqc.html", sample=SAMPLES),
		zipped_unpaired=expand(dirs_dict["CLEAN_DATA_DIR"]  + "/postQC" + "/{sample}_unpaired_clean.fastqc.zip", sample=SAMPLES),
	output:
